    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <main role="main">
            ...
            <section class="jumbotron text-center mt-1">
                <div class="container">
                    <img src="{{asset('images')}}/{{ $movie->mimg }}" alt="" class="img-fluid img-thumbnail rounded mx-auto d-block" style="width: 250px">
<br>
    <video autoplay muted loop  class="img-fluid img-thumbnail rounded mx-auto d-block" style="width: 500px">
